...
import MarketCap from './Screener'
...
const mapStateToProps = (state = {}, ownProps = {}) => {
  ...
  return {
    ...
    savedState: getComponentState(state, layoutID, 'screener', id),
...
export default connect(mapStateToProps, mapDispatchToProps)(MarketCap)
