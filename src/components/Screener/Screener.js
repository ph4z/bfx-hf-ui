...
import { propTypes, defaultProps } from './Screener.props'
import './style.css'
...
export default class Screener extends React.PureComponent {
    ...
    componentDidMount() {
      ...
      script.innerHTML = JSON.stringify({
        width: '1275', height: '490', defaultColumn: 'overview', defaultScreen: 'general', market: 'crypto', colorTheme: 'dark', showToolbar: true,
      })
