...
const renderLayoutActions = ({ layout = {}, onSubmit }) => { // eslint-disable-line
  ...
  return (
    <div
      key='of-actions'
      className={ClassNames('hfui-transferform__layout-actions', {
...
const renderLayoutSection = ({
  ...
  return (
    <div
      key={name}
      className={ClassNames('hfui-transferform__layout-section', {
        fullWidth,
      })}
    >
      {title && (
        <p className='hfui-transferform__layout-section-title'>{title}</p>
      )}
...
const renderLayout = ({
  ...
  if (_isObject(header)) {
    ...
    if (component !== 'ui.checkbox_group') {
      ...
      html.push((
        <div
          className='hfui-transferform__layout-header'
  ...
  return (
    <div className='hfui-transferform__layout' key='transferform-layout'>
      {html}
    </div>
  )
}
